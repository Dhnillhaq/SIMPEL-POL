<!-- Modal Konten Detail -->
<div
    class="bg-white rounded-lg shadow-lg max-w-3xl w-full p-6 relative max-h-[85%] overflow-y-auto border-t-4 border-blue-600">
    ...
    <div class="mb-6">
        ...
        <div class="mt-8 mb-10">
            <div class="mb-4">
                <h3 class="text-xl font-bold text-gray-800">Perencanaan Biaya Perbaikan</h3>
            </div>
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-left border border-gray-300">
                    <thead class="text-base text-gray-700 bg-white">
                        <tr>
                            <th scope="col" class="px-5 py-4 border border-gray-300 text-gray-900 text-center w-[75px]">
                                No</th>
                            <th scope="col" class="px-5 py-4 border border-gray-300 text-gray-900 text-left">Keterangan
                            </th>
                            <th scope="col" class="px-5 py-4 border border-gray-300 text-gray-900 text-left">Biaya (Rp)
                            </th>
                        </tr>
                    </thead>
                    <tbody class="text-gray-800">
                        ...
                        @empty
                            <tr class="font-medium">
                                <td colspan="3" class="text-center text-gray-500 py-4 bg-gray-100">Tidak ada data
        ...
        <div class="mb-6">
            <div class="flex items-center mb-4">
                ...
                <h3 class="text-lg font-semibold text-gray-800">Hasil Perhitungan SPK - Promethee</h3>
            </div>
            <div class="w-[335px] h-0.5 bg-orange-400 mb-6"></div>

            <div class="mb-10">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-left border border-gray-300">
                        <tbody class="text-gray-800">
                            <tr class="bg-gray-100 border-b border-gray-300 text-md">
                                <td class="px-5 py-4 border border-gray-300 text-left font-medium">
                                    Leaving Flow
                                </td>
                                <td class="px-5 py-4 border border-gray-300 text-left font-medium">
                                    {{ round($perhitungan['leaving_flow'], 3) }}
                                </td>
                            </tr>
                            <tr class="bg-white border-b border-gray-300 text-md">
                                <td class="px-5 py-4 border border-gray-300 text-left font-medium">
                                    Entering Flow
                                </td>
                                <td class="px-5 py-4 border border-gray-300 text-left font-medium">
                                    {{ round($perhitungan['entering_flow'], 3) }}
                                </td>
                            </tr>
                            <tr class="bg-gray-100 border-b border-gray-300 text-md">
                                <td class="px-5 py-4 border border-gray-300 text-left font-medium">
        ...
        <div class="flex justify-end">
            <button type="button" id="modal-close"
                class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none cursor-pointer">
                Kembali
            </button>
        </div>
    </div>
