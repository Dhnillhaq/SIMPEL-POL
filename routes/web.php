...
Route::prefix('admin')->middleware(['authorize:ADMIN'])->group(function () {
    ...
    Route::prefix('aduan')->group(function () {
        ...
        Route::get('/{perbaikan}/show_ajax', [AduanController::class, 'show_ajax'])->name('admin.aduan.show_ajax');
        Route::get('/{perbaikan}/comment_ajax', [AduanController::class, 'comment_ajax'])->name('admin.aduan.comment_ajax');
...
Route::middleware(['authorize:SARPRAS'])->group(function () {
    ...
    Route::prefix('pengaduan')->group(function () {
        ...
        Route::get('/info_bobot', [PengaduanSarprasController::class, 'info_bobot'])->name('sarpras.pengaduan.info');
